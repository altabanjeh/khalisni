function PageHeader({ icon: Icon, eyebrow, title, description, badge, actions }) {
  return (
    <header className="glass-panel flex flex-col gap-5 p-6 lg:flex-row lg:items-start lg:justify-between">
      ...
      {actions ? <div className="flex flex-wrap items-center gap-3 self-start lg:self-center">{actions}</div> : null}
    </header>
  )
}
