  ...
  return (
    <div className="page-section">
      ...
      {cards.waitingCustomer ? (
        <div className="rounded-[var(--radius-xl)] border border-amber-200 bg-amber-50 p-5 shadow-soft">
          ...
          <section className="glass-panel p-6">
            ...
            <div className="mt-4 space-y-3">
              {notifications.slice(0, 4).length ? notifications.slice(0, 4).map((notification) => (
                <div key={notification.id} className="rounded-[var(--radius-md)] border border-border bg-brand-50/40 px-4 py-4">
                  <div className="flex items-center justify-between gap-3">
