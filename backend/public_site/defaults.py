...
DEFAULT_SAMPLE_ADVERTISEMENT = {
    "title_ar": "إعلان ترحيبي",
    "title_en": "Welcome Announcement",
    "description_ar": "يمكنك الآن متابعة طلباتك الحكومية والإدارية من مكان واحد.",
    "description_en": "You can now track your government and admin requests from one place.",
    "advertisement_type": "general",
    "button_text_ar": "استعرض الخدمات",
